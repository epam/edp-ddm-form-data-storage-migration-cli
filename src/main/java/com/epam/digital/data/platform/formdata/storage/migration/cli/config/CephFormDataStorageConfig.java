...
public class CephFormDataStorageConfig {
  ...
  @Bean
  public StorageServiceFactory cephStorageServiceFactory(
  ...
  public FormDataStorageService cephFormDataStorageService(
      StorageServiceFactory cephStorageServiceFactory, CephStorageConfiguration config) {
    return cephStorageServiceFactory.formDataStorageService(config);
  }
}
